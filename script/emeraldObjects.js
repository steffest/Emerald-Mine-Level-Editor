var Emerald = function(){
	...
	me.objects = {
		empty: 		{code: "  ", spriteIndex:0},
		fakeSpace: 	{code: " f", spriteIndex:1},
		wall:  		{code: "Ws", spriteIndex:10},
		slipperyWall:{code: "WS", spriteIndex:13},
		stoneWall:	{code: "Ww", spriteIndex:12},
		dirt:  		{code: "..", spriteIndex:20},
		rock:  		{code: "rr", spriteIndex:30},
		...
		robotWheel: {code: "Rw", spriteIndex:36},
		...
		fakeDirt:   {code: ".f", spriteIndex:70},
